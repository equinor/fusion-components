import WorkOrderType from "../components/workordergarden/models/WorkOrderType";
...
const woHasMaterialStatus = (workOrder: WorkOrderType, ...statuses: string[]) => {
    ...
    return materialStatuses.filter(materialStatus => woMaterialStatus.indexOf(materialStatus) === 0)
        .length;
};
