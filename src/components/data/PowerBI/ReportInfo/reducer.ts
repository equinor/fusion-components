...
export const fetchReport = (initial: State) =>
  createReducer<State, ActionType<typeof actions.fetchReport>>(initial)
    .handleAction(actions.fetchReport.success, (state, action) => ({
      ...state,
...
export const fetchReportDescription = (initial: State) =>
  createReducer<State, ActionType<typeof actions.fetchReportDescription>>(initial)
    .handleAction(actions.fetchReportDescription.success, (state, action) => ({
      ...state,
...
export const fetchReportAccessDescription = (initial: State) =>
  createReducer<State, ActionType<typeof actions.fetchReportAccessDescription>>(initial)
...
export const fetchReportRequirments = (initial: State) =>
  createReducer<State, ActionType<typeof actions.fetchReportRequirements>>(initial)
    .handleAction(actions.fetchReportRequirements.success, (state, action) => ({
      ...state,
...
export const reducer = (initial: State) => createReducer<State, Actions>(initial, {
  ...
  ...fetchReportRequirments(initial).handlers,
