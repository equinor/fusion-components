...
const Spinner = ({ floating, centered, primary, children, title, small, size, inline, ...props }) => {
    //Positioning
        ...
        return(
            <div className={containerClassNames} {...props}>
                <div className={spinnerClassNames}>
                    <svg className={styles.spinnerBox} viewBox="24 24 48 48" style={{ width: size, height: size }}>
                        <circle className={styles.spinnerBorder}
                                cx="48" cy="48" r="20" fill="none" strokeWidth={3} strokeMiterlimit="10"
                        />
                    </svg>
                </div>
            </div>
