...
export const useStyles = makeStyles(() =>
	createStyles({
		...
		highlighted: (props: { isRotation: boolean; hasOverlap: boolean }) => ({
			background: props.hasOverlap ? theme.colors.interactive.danger__highlight.getVariable('color') : theme.colors.interactive.success__highlight.getVariable('color'),
		}),
		disabled: {
