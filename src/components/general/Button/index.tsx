...
const Button = React.forwardRef<HTMLElement | null, React.PropsWithChildren<ButtonProps>>((props, ref) => {
    ...
    const buttonRef = ref as React.RefObject<HTMLElement | null> || React.createRef<HTMLElement | null>();
